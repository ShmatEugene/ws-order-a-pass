      ...
      <svg
        ...
        <defs>
          <linearGradient
            ...
            <stop offset="0.38" stopColor="#aba79f" />
            <stop offset="1" />
          </linearGradient>
        </defs>
        <title>333</title>
        <rect className="cls-1" y="1" width="339.87" height="323.13" rx="20.05" ry="20.05" />
        <path
          className="cls-2"
        ...
        />
        <image width="800" height="1011" transform="translate(76) scale(0.25)" href={imgSrc} />
        <rect className="cls-3" y="474" width="339.87" height="99" rx="15.39" ry="15.39" />
        <text className="cls-4" transform="translate(30.44 280.83)">
          Временный проп
          <tspan className="cls-5" x="127.02" y="0">
            у
          </tspan>
          <tspan className="cls-6" x="135.03" y="0">
            ск
          </tspan>
        </text>
        <text className="cls-7" transform="translate(28.39 365.9) rotate(-0.14)">
          с
        </text>
        <path
          className="cls-8"
          d="M179.13,351.49l0,13.37h-3.87l0-10.19h-5.57l0,10.19h-3.85l0-13.37Z"
        ...
        <path
          ...
          transform="translate(0 1)"
        />
        <text className="cls-9" transform="translate(164.01 365.9) rotate(-0.14)">
          по
        </text>
        <text className="cls-10" transform="translate(52.27 366.24) rotate(-0.14)">
          <tspan className="cls-11">
            {startDate && `${startDate.split('-')[2]}/${startDate.split('-')[1]}`}
          </tspan>
        </text>
        <text className="cls-14" transform="translate(30.44 308.45)">
          {name}
        </text>
        <text className="cls-15" transform="translate(206.3 366.24) rotate(-0.14)">
          {endDate && `${endDate.split('-')[2]}/${endDate.split('-')[1]}`}
          {/* {state.formData &&
            state.formData.endDate.value &&
            `${state.formData.endDate.value.split('-')[2]}/${
              state.formData.endDate.value.split('-')[1]
            }`} */}
        </text>
        <path
          className="cls-2"
        ...
        <path
          ...
          transform="translate(0 1)"
        />
        <text className="cls-19" transform="translate(29.98 406)">
          ASD
          <tspan className="cls-20" x="21.46" y="0">
            K
          </tspan>
          <tspan x="28.77" y="0">
            18
          </tspan>
          <tspan className="cls-21" x="38.89" y="0">
            9
          </tspan>
          <tspan x="44.96" y="0">
            13IO$
          </tspan>
          <tspan className="cls-22" x="71.84" y="0">
            A
          </tspan>
          <tspan x="79.35" y="0">
            J
          </tspan>
          <tspan className="cls-23" x="84.56" y="0">
            K
          </tspan>
          <tspan x="91.54" y="0">
            S
          </tspan>
          <tspan className="cls-23" x="97.67" y="0">
            DJ
          </tspan>
          <tspan className="cls-24" x="110.54" y="0">
            A
          </tspan>
          <tspan className="cls-25" x="117.91" y="0">
            K
          </tspan>
          <tspan className="cls-26" x="124.73" y="0">
            A
          </tspan>
          <tspan x="131.75" y="0">
            X&gt;AS
          </tspan>
          <tspan className="cls-27" x="157.89" y="0">
            D
          </tspan>
          <tspan className="cls-28" x="165.74" y="0">
            A
          </tspan>
          <tspan x="173.33" y="0">
            AS&gt;AS
          </tspan>
          <tspan className="cls-27" x="206.11" y="0">
            D
          </tspan>
          <tspan x="213.96" y="0">
            1A
          </tspan>
          <tspan className="cls-27" x="225.11" y="0">
            S
          </tspan>
          <tspan x="231.15" y="0">
            1213I12SL&gt;
          </tspan>
          <tspan className="cls-29" x="0" y="11.55">
            T
          </tspan>
          <tspan className="cls-30" x="5.82" y="11.55">
            Y
          </tspan>
          <tspan x="12.37" y="11.55">
            30
          </tspan>
          <tspan className="cls-31" x="24.6" y="11.55">
            4
          </tspan>
          <tspan x="31.33" y="11.55">
            O
          </tspan>
          <tspan className="cls-32" x="39.45" y="11.55">
            0
          </tspan>
          <tspan x="45.92" y="11.55">
            2OI
          </tspan>
          <tspan className="cls-33" x="62.87" y="11.55">
            E
          </tspan>
          <tspan x="69.23" y="11.55">
            0
          </tspan>
          <tspan className="cls-34" x="75.77" y="11.55">
            R
          </tspan>
          <tspan x="82.8" y="11.55">
            3RI
          </tspan>
          <tspan className="cls-35" x="98.72" y="11.55">
            O
          </tspan>
          <tspan x="106.7" y="11.55">
            JER0
          </tspan>
          <tspan className="cls-21" x="131.96" y="11.55">
            9
          </tspan>
          <tspan className="cls-27" x="138.03" y="11.55">
            2
          </tspan>
          <tspan className="cls-36" x="143.61" y="11.55">
            4
          </tspan>
          <tspan x="150.3" y="11.55">
            JS
          </tspan>
          <tspan className="cls-37" x="161.64" y="11.55">
            F
          </tspan>
          <tspan className="cls-38" x="167.68" y="11.55">
            0
          </tspan>
          <tspan className="cls-39" x="174.21" y="11.55">
            9
          </tspan>
          <tspan x="180.28" y="11.55">
            23
          </tspan>
          <tspan className="cls-40" x="191.65" y="11.55">
            K
          </tspan>
          <tspan x="198.53" y="11.55">
            O
          </tspan>
          <tspan className="cls-27" x="206.65" y="11.55">
            P
          </tspan>
          <tspan x="213.6" y="11.55">
            D&gt;310D
          </tspan>
          <tspan className="cls-41" x="251.26" y="11.55">
            K
          </tspan>
          <tspan className="cls-42" x="258.03" y="11.55">
            -
          </tspan>
          <tspan x="261.78" y="11.55">
            QE
          </tspan>
          <tspan x="0" y="23.09">
            I
          </tspan>
          <tspan className="cls-35" x="3.16" y="23.09">
            O
          </tspan>
          <tspan className="cls-43" x="11.13" y="23.09">
            JP
          </tspan>
          <tspan className="cls-29" x="23.38" y="23.09">
            O
          </tspan>
          <tspan x="31.37" y="23.09">
            31IHUI
          </tspan>
          <tspan className="cls-44" x="62.51" y="23.09">
            E
          </tspan>
          <tspan x="68.95" y="23.09">
            ODIJ
          </tspan>
          <tspan className="cls-45" x="93.37" y="23.09">
            -
          </tspan>
          <tspan className="cls-44" x="96.93" y="23.09">
            2
          </tspan>
          <tspan className="cls-46" x="102.59" y="23.09">
            0
          </tspan>
          <tspan x="109.03" y="23.09">
            34IJR
          </tspan>
          <tspan className="cls-47" x="136.78" y="23.09">
            K
          </tspan>
          <tspan x="143.66" y="23.09">
            OEP12
          </tspan>
          <tspan className="cls-47" x="174.73" y="23.09">
            K
          </tspan>
          <tspan className="cls-38" x="181.61" y="23.09">
            O
          </tspan>
          <tspan className="cls-27" x="189.73" y="23.09">
            P
          </tspan>
          <tspan x="196.68" y="23.09">
            IJ&gt;
          </tspan>
          <tspan className="cls-48" x="210.8" y="23.09">
            A
          </tspan>
          <tspan className="cls-49" x="218.39" y="23.09">
            ASDODIFHU
          </tspan>
        </text>
